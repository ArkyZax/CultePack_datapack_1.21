...
attribute @s generic.max_health modifier add up_2_vie 50 add_value
attribute @s generic.attack_damage modifier add up_2_dmg 2 add_value
attribute @s generic.movement_speed modifier add up_speed 0.2 add_value
